 ...
 *
 */
public class StatisticsBusiness extends BaseQuartzJobBean {
	StatisticsBusinessService businessService =ServiceHelper.getStatisticsBusinessService();
	protected void executeInternal(JobExecutionContext context)throws JobExecutionException {
    	BscJob bscJob=new BscJob();
    	BaseJoblog baseJoblog=new BaseJoblog();
        Boolean isLog = true;
        try {
        	bscJob.setJobcode(Const.Job_Code.STATISTICS_JOBACCOUNT.name());

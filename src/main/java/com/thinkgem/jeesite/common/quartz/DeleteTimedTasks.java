 ...
 *
 */
public class DeleteTimedTasks extends BaseQuartzJobBean {


	TradeBiz tradeBiz = (TradeBiz) ServiceHelper.getService("tradeBiz");
	protected void executeInternal(JobExecutionContext context)throws JobExecutionException {
    	BscJob bscJob=new BscJob();
    	BaseJoblog baseJoblog=new BaseJoblog();
        Boolean isLog = true;
        try {
        	bscJob.setJobcode(Const.Job_Code.STATISTICS_RAIL_DELETE.name());

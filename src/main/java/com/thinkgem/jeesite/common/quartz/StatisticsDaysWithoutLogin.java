...
public class StatisticsDaysWithoutLogin extends BaseQuartzJobBean{
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        Boolean isLog = true;
        try {
            bscJob.setJobcode(Const.Job_Code.STATISTICS_DAYSWITHOUTLOGIN.name());
    ...
    private void acquStart(BscJob pdJobLog, BaseJoblog baseJoblog, Boolean isLog) throws Exception {
        ...
        integrityBiz.getWithLoginUsers();

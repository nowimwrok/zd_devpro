 ...
 *
 */
public class StatisticsCar extends BaseQuartzJobBean {
	StatisticsCarService carService = ServiceHelper.getStatisticsCarService();
	protected void executeInternal(JobExecutionContext context)throws JobExecutionException {
    	BscJob bscJob=new BscJob();
    	BaseJoblog baseJoblog=new BaseJoblog();
        Boolean isLog = true;
        try {
        	bscJob.setJobcode(Const.Job_Code.STATISTICS_CAR.name());

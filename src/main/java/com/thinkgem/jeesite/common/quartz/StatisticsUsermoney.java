 ...
 *
 */
public class StatisticsUsermoney extends BaseQuartzJobBean {

	StatisticsUsermoneyService usermoneyService = ServiceHelper.getStatisticsUsermoneyService();
	...
	protected void executeInternal(JobExecutionContext context)throws JobExecutionException {
        ...
        Boolean isLog = true;
        try {
        	bscJob.setJobcode(Const.Job_Code.STATISTICS_USERMONEY.name());
    ...
    private void acquStart(BscJob pdJobLog,BaseJoblog baseJoblog, Boolean isLog) throws Exception {
        ...
        //账户资金统计
        usermoneyService.editUsermoney();
    }
}

...
import com.thinkgem.jeesite.modules.wlpt.biz.accounts.AccountsBiz;
 ...
 *
 */
public class StatisticsAccount  extends BaseQuartzJobBean {

    AccountsBiz accountsBiz = (AccountsBiz) ServiceHelper.getService("accountsBiz");
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        Boolean isLog = true;
        try {
            bscJob.setJobcode(Const.Job_Code.STATISTICS_ACCOUNT.name());
    ...
    private void acquStart(BscJob pdJobLog, BaseJoblog baseJoblog, Boolean isLog) throws Exception {
        ...
        //平台对账统计
        accountsBiz.findAccountWebBalance();
    }
}
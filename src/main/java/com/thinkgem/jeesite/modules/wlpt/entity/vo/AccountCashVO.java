 ...
 * @version 2016-07-24
 */
public class AccountCashVO extends DataEntity<AccountCashVO> {
	...
	@ExcelField(title = "余额提现", type = 1, align = 2, sort = 14)
	...
	@ExcelField(title = "收到余额提现", type = 1, align = 2, sort = 15)
	...
	@ExcelField(title = "余额提现退款", type = 1, align = 2, sort = 16)

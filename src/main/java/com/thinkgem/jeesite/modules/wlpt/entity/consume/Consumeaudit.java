 ...
 * @version 2016-08-02
 */
public class Consumeaudit extends DataEntity<Consumeaudit> {
	...
	private List<Deallog> list;//审核记录
	
	public Consumeaudit() {
		super();
	}

	public Consumeaudit(String id){
		super(id);
	}
	...
	@ExcelField(title = "审核状态",align = 2,sort = 12,dictType="consumeaudit_status")
	...
	@ExcelField(title = "银行卡", align = 2, sort = 4, value = "user.bankinfo.bankcard")
	public String bankcard(){
		if(getUser()!=null&&getUser().getBankinfo()!=null&&!Tools.IsNullOrWhiteSpace(getUser().getBankinfo().getBankcard())){
			return getUser().getBankinfo().getBankcard();
		}
		return "";
		
	}
	
	@ExcelField(title = "账户名", align = 2, sort = 5, value = "user.bankinfo.accountName")
	public String accountName(){
		if(getUser()!=null&&getUser().getBankinfo()!=null&&!Tools.IsNullOrWhiteSpace(getUser().getBankinfo().getAccountName())){
			return getUser().getBankinfo().getAccountName();
		}
		return "";
		
	}
	
	@ExcelField(title = "银行类型", align = 2, sort = 6, value = "user.bankinfo.banktype")
	public String banktype(){
		if(getUser()!=null&&getUser().getBankinfo()!=null&&!Tools.IsNullOrWhiteSpace(getUser().getBankinfo().getBanktype())){
			return getUser().getBankinfo().getBanktype();
		}
		return "";
	}
	
	@ExcelField(title = "支行信息", align = 2, sort = 7, value = "user.bankinfo.bankname")
	public String bankname(){
		if(getUser()!=null&&getUser().getBankinfo()!=null&&!Tools.IsNullOrWhiteSpace(getUser().getBankinfo().getBankname())){
			return getUser().getBankinfo().getBankname();
		}
		return "";
	}
	
	@ExcelField(title = "提现前", align = 2, sort = 8, value = "consume.beforemony")
	...
	@ExcelField(title = "提现金额", align = 2, sort = 9, value = "consume.consumemony")
	...
	@ExcelField(title = "提现后", align = 2, sort = 10, value = "consume.aftermony")
	...
	@ExcelField(title = "交易方式", align = 2, sort = 11, value = "consume.consumeway",dictType="consumerecode_way")
	public String consumeway(){
		if(getConsume()!=null&&!Tools.IsNullOrWhiteSpace(getConsume().getConsumeway())){
			return getConsume().getConsumeway();
		}
		return "";
		
	}
	
	@ExcelField(title = "申请时间", align = 2, sort = 14, value = "createDate")
	...
	@ExcelField(title = "更新者", align = 2, sort = 14, value = "updateBy.loginName")
	...
	public List<Deallog> getList() {
		return list;
	}

	public void setList(List<Deallog> list) {
		this.list = list;
	}

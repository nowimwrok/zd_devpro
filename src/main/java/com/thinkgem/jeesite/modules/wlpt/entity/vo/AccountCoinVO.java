 ...
 * @version 2016-07-24
 */
public class AccountCoinVO extends DataEntity<AccountCoinVO> {
	...
	@ExcelField(title = "Z币充值", type = 1, align = 2, sort = 20)
	...
	@ExcelField(title = "运费冻结", type = 1, align = 2, sort = 50)
	...
	@ExcelField(title = "运费预付", type = 1, align = 2, sort = 51)
	...
	@ExcelField(title = "预付收入", type = 1, align = 2, sort = 54)
	...
	@ExcelField(title = "运费尾付", type = 1, align = 2, sort = 52)
	...
	@ExcelField(title = "尾款收入", type = 1, align = 2, sort = 55)
	...
	@ExcelField(title = "Z币结算支出", type = 1, align = 2, sort = 40)
	...
	@ExcelField(title = "Z币结算收入", type = 1, align = 2, sort = 41)
	...
	@ExcelField(title = "购买油气", type = 1, align = 2, sort = 70)
	...
	@ExcelField(title = "Z币余额", type = 1, align = 2, sort = 10)
	public Double getWebcoin() {
		return user.getUserPurse().getWebcoin();
	}

	@ExcelField(title = "Z币可用余额", type = 1, align = 2, sort = 11)
	public Double getAvailablecoin() {
		return user.getUserPurse().getAvailablecoin();
	}

	@ExcelField(title = "Z币冻结", type = 1, align = 2, sort = 12)
	public Double getFreezecoin() {
		return user.getUserPurse().getFreezecoin();
	}

	@ExcelField(title = "销售收入", type = 1, align = 2, sort = 61)
	public Double coinconsume() {
		return 0.0;
	}

	@ExcelField(title = "Z币转账支出", type = 1, align = 2, sort = 31)
	...
	@ExcelField(title = "Z币转账收入", type = 1, align = 2, sort = 30)

 ...
 * @version 2016-07-24
 */
public class UserAccountBalanceVO extends DataEntity<UserAccountBalanceVO> {
    ...
    @ExcelField(title = "可用账户余额", type = 1, align = 2, sort = 4)
    ...
    @ExcelField(title = "冻结金额", type = 1, align = 2, sort = 5)
    ...
    @ExcelField(title = "运费冻结", type = 1, align = 2, sort = 6)
    ...
    @ExcelField(title = "运费预付", type = 1, align = 2, sort = 7)
    public Double getPaypremoney() {
        return paypremoney;
    }

    @ExcelField(title = "运费尾付", type = 1, align = 2, sort = 8)
    public Double getPayonlienmoney() {
        return payonlienmoney;
    }

    @ExcelField(title = "运费取消退款", type = 1, align = 2, sort = 9)
    public Double getReturnforzen() {
        return returnforzen;
    }

    @ExcelField(title = "收到预付", type = 1, align = 2, sort = 10)
    public Double getGetpremoney() {
        return getpremoney;
    }

    @ExcelField(title = "收到尾付", type = 1, align = 2, sort = 11)
    public Double getGetonlinemoney() {
        return getonlinemoney;
    }

    @ExcelField(title = "争议退费", type = 1, align = 2, sort = 12)
    public Double getDisputemoneyreturn() {
        return disputemoneyreturn;
    }

    @ExcelField(title = "缴纳竞标保证金", type = 1, align = 2, sort = 13)
    ...
    @ExcelField(title = "竞标保证金退款", type = 1, align = 2, sort = 14)
    ...
    @ExcelField(title = "结算支出", type = 1, align = 2, sort = 15)
    ...
    @ExcelField(title = "结算收入", type = 1, align = 2, sort = 16)
    ...
    @ExcelField(title = "转账支出", type = 1, align = 2, sort = 17)
    ...
    @ExcelField(title = "转账收入", type = 1, align = 2, sort = 18)
    public Double getReceivedtransfer() {
        return receivedtransfer;
    }

    @ExcelField(title = "提现冻结", type = 1, align = 2, sort = 19)
    ...
    @ExcelField(title = "提现驳回退款", type = 1, align = 2, sort = 20)
    public Double getCashmoneyreturn() {
        return cashmoneyreturn;
    }

    @ExcelField(title = "已提现", type = 1, align = 2, sort = 21)
    ...
    /*@ExcelField(title = "缴费支出", type = 1, align = 2, sort = 28)*/
    ...
    /*@ExcelField(title = "缴费收入", type = 1, align = 2, sort = 29)*/

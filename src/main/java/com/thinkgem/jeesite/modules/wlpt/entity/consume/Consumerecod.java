 ...
 * @version 2016-08-02
 */
public class Consumerecod extends DataEntity<Consumerecod> {
    ...
    private String tradeSettlementId; //账户系统业务结算单号
	private String awardno;		// 获奖编号
	private String plusStatus;		///入账或出帐
	...
	/// 交易模块
	@ExcelField(type = 1, title = "交易模块", align = 2, sort = 9, dictType = "consumerecode_model")
	...
	@NotNull(message = "当前用户不允许为空")
	@ExcelField(type = 1, title = "流出用户登陆名", align = 2, sort = 1)
	...
	@NotNull(message = "当前用户不允许为空")
	@ExcelField(type = 1, title = "流出用户手机号", align = 2, sort = 2)
	...
	@ExcelField(type = 1, title = "关联流水", align = 2, sort = 5)
	...
	@ExcelField(type = 1, title = "交易类型", align = 2, sort = 6, dictType = "consumerecode_type")
	...
	@ExcelField(type = 1, title = "交易方式", align = 2, sort = 7, dictType = "consumerecode_way")
	...
	@ExcelField(type = 1, title = "运单号", align = 2, sort = 14)
	...
	@ExcelField(type = 1, title = "交易状态", align = 2, sort = 8, dictType = "consume_status")
	...
	@ExcelField(type = 1, title = "交易时间", align = 1, sort = 15)
	...
	public void setPlusStatus(String plusStatus) {

...
/**
 * 运单交易模块导出excel拓展Entity
 * 
 * @author fjc
 * @version 2016-07-24
 */
public class AccountTradeOrderVO extends DataEntity<AccountTradeOrderVO> {
	...
	@ExcelField(title = "运费支出", type = 1, align = 2, sort = 14)
	...
	@ExcelField(title = "运费返款", type = 1, align = 2, sort = 15)
	...
	@ExcelField(title = "运费收到预付", type = 1, align = 2, sort = 16)
	...
	@ExcelField(title = "运费预付支出", type = 1, align = 2, sort = 17)
	...
	@ExcelField(title = "运费余款支付", type = 1, align = 2, sort = 18)
	...
	@ExcelField(title = "运费收到余款", type = 1, align = 2, sort = 19)
	...
	@ExcelField(title = "运费争议退款", type = 1, align = 2, sort = 110)
	...
	@ExcelField(title = "争议余款支付", type = 1, align = 2, sort = 111)
	...
	@ExcelField(title = "卓币运费冻结", type = 1, align = 2, sort = 112)
	...
	@ExcelField(title = "卓币运费预付", type = 1, align = 2, sort = 113)
	...
	@ExcelField(title = "卓币收到预付", type = 1, align = 2, sort = 114)
	...
	@ExcelField(title = "卓币支付余款", type = 1, align = 2, sort = 115)
	...
	@ExcelField(title = "卓币收到余款", type = 1, align = 2, sort = 116)
	...
	@ExcelField(title = "运费收到冻结", type = 1, align = 2, sort = 117)
	...
	@ExcelField(title = "卓币收到冻结", type = 1, align = 2, sort = 118)
	...
	@ExcelField(title = "卓币解冻", type = 1, align = 2, sort = 119)
	...
	@ExcelField(title = "打印提货单缴费", type = 1, align = 2, sort = 120)
	...
	@ExcelField(title = "收到打印缴费", type = 1, align = 2, sort = 121)
	...
	@ExcelField(title = "卓币支付LBS定位", type = 1, align = 2, sort = 122)
	...
	@ExcelField(title = "卓币收到LBS定位", type = 1, align = 2, sort = 123)
	...
	@ExcelField(title = "余额支付LBS定位", type = 1, align = 2, sort = 124)
	...
	@ExcelField(title = "余额收到LBS定位", type = 1, align = 2, sort = 125)

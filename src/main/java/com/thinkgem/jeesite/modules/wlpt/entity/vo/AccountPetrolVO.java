 ...
 * @version 2016-07-24
 */
public class AccountPetrolVO extends DataEntity<AccountPetrolVO> {
	...
	@ExcelField(title = "油气收到充值", type = 1, align = 2, sort = 8)
	...
	@ExcelField(title = "油气支付消费", type = 1, align = 2, sort = 9)
	...
	@ExcelField(title = "油气支付充值", type = 1, align = 2, sort = 7)
	...
	@ExcelField(title = "油气收到消费", type = 1, align = 2, sort = 10)
	...
	@ExcelField(title = "油气余额", type = 1, align = 2, sort = 4)
	...
	@ExcelField(title = "油气支出转账", type = 1, align = 2, sort = 5)
	...
	@ExcelField(title = "油气收到转账", type = 1, align = 2, sort = 6)
	...
	@ExcelField(title = "油气收到赠送", type = 1, align = 2, sort = 12)
	...
	@ExcelField(title = "油气支付赠送", type = 1, align = 2, sort = 11)
	...
	@ExcelField(title = "油气支付兑换", type = 1, align = 2, sort = 13)
	...
	@ExcelField(title = "油气收到兑换", type = 1, align = 2, sort = 14)

 ...
 * @version 2016-07-24
 */
public class AccountBalanceVO extends DataEntity<AccountBalanceVO> {
	...
	@ExcelField(title = "充值", type = 1, align = 2, sort = 14)
	...
	@ExcelField(title = "运费冻结", type = 1, align = 2, sort = 40)
	...
	@ExcelField(title = "运费取消退款", type = 1, align = 2, sort = 43)
	...
	@ExcelField(title = "运费预付", type = 1, align = 2, sort = 44)
...
//	@ExcelField(title = "运费预付", type = 1, align = 2, sort = 41)
...
//	@ExcelField(title = "运费尾付", type = 1, align = 2, sort = 42)
	...
	@ExcelField(title = "运费尾付", type = 1, align = 2, sort = 45)
	...
	@ExcelField(title = "争议收入", type = 1, align = 2, sort = 71)
	...
	@ExcelField(title = "缴费支出", type = 1, align = 2, sort = 80)
	...
	@ExcelField(title = "缴费收入", type = 1, align = 2, sort = 81)
	...
	@ExcelField(title = "结算支出", type = 1, align = 2, sort = 35)
	...
	@ExcelField(title = "结算收入", type = 1, align = 2, sort = 36)
	...
	@ExcelField(title = "结算提现", type = 1, align = 2, sort = 37)
	...
	@ExcelField(title = "缴纳竞标保证金", type = 1, align = 2, sort = 31)
	...
	@ExcelField(title = "竞标保证金退款", type = 1, align = 2, sort = 32)
	...
	@ExcelField(title = "提现冻结", type = 1, align = 2, sort = 50)
	...
	@ExcelField(title = "已提现", type = 1, align = 2, sort = 52)
	...
	@ExcelField(title = "提现驳回退款", type = 1, align = 2, sort = 51)
	...
	@ExcelField(title = "转账收入", type = 1, align = 2, sort = 20)
	...
	@ExcelField(title = "消费支出", type = 1, align = 2, sort = 60)
	public Double getCoinrecharge() {
		return coinrecharge;
	}

	@ExcelField(title = "销售收入", type = 1, align = 2, sort = 61)
	...
	@ExcelField(title = "保证金余额", type = 1, align = 2, sort = 3)
	public Double getGuaranteemone() {

		return user.getUserPurse().getGuaranteemone();
	}

	@ExcelField(title = "冻结金额", type = 1, align = 2, sort = 6)
	...
	@ExcelField(title = "保证金冻结", type = 1, align = 2, sort = 70)

package com.thinkgem.jeesite.modules.wlpt.webapi.dataCenter;
...
@Controller
@RequestMapping(value="${frontPath}/wlpt/dataCenter")
public class DataCenterIndexController extends BaseController{

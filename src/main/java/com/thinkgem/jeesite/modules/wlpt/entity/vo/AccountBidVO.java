 ...
 * @version 2016-07-24
 */
public class AccountBidVO extends DataEntity<AccountBidVO> {
	...
	@ExcelField(title = "招标结算支付", type = 1, align = 2, sort = 14)
	...
	@ExcelField(title = "招标收到结算", type = 1, align = 2, sort = 15)
	...
	@ExcelField(title = "招标结算提现", type = 1, align = 2, sort = 16)
	...
	@ExcelField(title = "招标结算卓币", type = 1, align = 2, sort = 17)
	...
	@ExcelField(title = "收到结算卓币", type = 1, align = 2, sort = 18)

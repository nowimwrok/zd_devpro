 ...
 * @version 2016-07-24
 */
public class AccountTransferVO extends DataEntity<AccountTransferVO> {
	...
	@ExcelField(title = "余额转账", type = 1, align = 2, sort = 14)
	...
	@ExcelField(title = "余额收到转账", type = 1, align = 2, sort = 15)

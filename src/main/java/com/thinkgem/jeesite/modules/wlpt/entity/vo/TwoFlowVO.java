...
public class TwoFlowVO extends DataEntity<TwoFlowVO>{
	...
	@ExcelField(type = 1, title = "对方账户Id", align = 2, sort = 7)
	...
	@ExcelField(type = 1, title = "对方账户号", align = 2, sort = 8)
	...
	@ExcelField(type = 1, title = "对方账户名", align = 2, sort = 9)
	...
	@ExcelField(type = 1, title = "对方银行", align = 2, sort = 10)
	...
	@ExcelField(type = 1, title = "冲正ID", align = 2, sort = 11)

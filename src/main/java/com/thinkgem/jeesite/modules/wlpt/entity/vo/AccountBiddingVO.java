 ...
 * @version 2016-07-24
 */
public class AccountBiddingVO extends DataEntity<AccountBiddingVO> {
	...
	@ExcelField(title = "缴纳保证金", type = 1, align = 2, sort = 14)
	...
	@ExcelField(title = "收到保证金", type = 1, align = 2, sort = 15)
	...
	@ExcelField(title = "退还保证金", type = 1, align = 2, sort = 16)

...
jQuery.validator.addMethod("mobile", function (c, a) {
    var b = c.length;
    return this.optional(a) || (b == 11 && /(^1[3,5,7,8]\d{9})$/.test(c))
}, "请正确填写您的手机号码");
...
jQuery.validator.addMethod("isCarNumber", function(c, b) {
	var a  = /^[A-Z]{1}[A-Z_0-9]{5}$/;
    return this.optional(b) || (a.test(c))
}, "车牌号码格式错误");


jQuery.validator.addMethod("isCarNumbers", function(c, b) {
	var a  = /^[\u4e00-\u9fa5]{1}[A-Z]{1}[A-Z_0-9]{5}$/;
    return this.optional(b) || (a.test(c))
}, "车牌号码格式错误");

...
//			$(".pcc-title-ul").attr("style", "border-bottom:3px solid "+settings.color+";");
		...
		function getStyle(id,color) {
			...
			style += '.pcc-title-ul'+id+' { border-bottom:3px solid '+color+';width: 100%;height: 24px;list-style: none;margin: 0px;padding: 0px;text-align: center;cursor: pointer;}';
			...
			style += '.pcc-close'+id+'{position:absolute;right:10px;top:10px;width:15px;height:15px;cursor:pointer;border:solid 1px '+color+';}';
			style += '.pcc-close-icon'+id+'{padding:4px; font-family:"微软雅黑"; color:'+ color +'}';

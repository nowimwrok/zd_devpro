...
function searchCar() {
	...
	window.location.href="weixin/carsource?pagenow=1&fromProvince=" + fromProvince + "&fromCity=" + fromCity + "&fromDistrict=" + fromDistrict + "&toProvince=" + toProvince +"&toCity=" + toCity + "&toDistrict=" + toDistrict + "&carType=" + carType + "&carLengthMin=" + carLengthMin + "&carLengthMax=" + carLengthMax + "&loadWeightMin=" + loadWeightMin + "&loadWeightMax=" + loadWeightMax + "&flag=" + flag;
}

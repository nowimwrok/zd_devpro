(function ($) {
    ...
    $.fn.valid.rules = [
        ...
        { name: "isNum", title: "数字", regex: /^\d+$/, msg: "必须是整数" },
        { name: "decimal", title: "输入值-小数", regex: /^-?\d+(\.\d{1,4})?$/, msg: "只能为数字或小数且小数点后不能超过4位" },
        { name: "decimalTwo", title: "输入值-小数", regex: /^-?\d+(\.\d{1,2})?$/, msg: "只能为数字或小数且小数点后不能超过2位" },
        ...
        { name: "isQQ", title: "QQ", regex: /^[1-9]\d{4,9}$/, msg: "请正确填写您的QQ号码" },

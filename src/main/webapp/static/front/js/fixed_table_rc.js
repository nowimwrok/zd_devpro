...
(function ($) {
	...
	$.fn.fxdHdrCol = function (o) {
		...
		return this.each (function () {
			...
			var $this = $(this);
			$this.addClass('ui-widget-header table');
			...
			lc.ft_wrapper = $this.parent().css('width', cfg.width);
			...
			lc.ft_rel_container
				.prepend($(cfg.tableTmpl(), {'class': 'ft_r ui-widget-header table'})
				.append(theadTrClone));
			...
			if (cfg.fixedCols > 0) {
				...
				lc.ft_rel_container
					.prepend($(cfg.tableTmpl(), {'class': 'ft_rc ui-widget-header table'})
					.append(theadTrClone));
			...
			lc.ft_r
				.parent()
				.css({width: lc.ft_wrapper.width()-3});

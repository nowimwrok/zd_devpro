...
<head>
    ...
    <title>${fns:getConst('SYSTEMTITLE')}--修改支付密码</title>
    ...
    <script type="text/javascript" src="${ctxStatic}/weixin/js/weixin/updatecashpassword.js?id=1234"></script>
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<div class="data_top data_tab" style="width:100%;padding:0px;color: white;">
		...
		<div class="selected data_tab_center">支付密码</div>
    ...
    <div>
        <form>
            <div id="form">
                <table align="center">
                    <tr>
                        <td><input type="text" id="txtPhoneNumber" name="txtPhoneNumber" value="${user.user.phone }"
                                   placeholder="手机号码" maxlength="11" readonly="true"/></td>
                    </tr>
                    <tr>
                        <td><input type="password" id="txtPassWord" name="txtPassWord" onblur="checkPwd()"
                                   placeholder="新支付密码(6-16位数字，字母，符号)" maxlength="16"/></td>
                    </tr>
                    <tr>
                        <td><input type="password" id="txtConfirmPwd" name="txtConfirmPwd" onblur="checkConfirmPwd()"
                                   placeholder="请再次输入新支付密码以确认" maxlength="16"/></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td><input id="btnSubmit" type="button" readonly="readonly" onclick="changePwd()" value="提    交"/><input type="hidden"

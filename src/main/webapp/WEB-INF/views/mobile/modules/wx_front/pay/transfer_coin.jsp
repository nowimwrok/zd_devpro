...
<title>${fns:getConst('SYSTEMTITLE')}--卓币转账</title>
...
<body>
	<div class="data_top data_tab" style="width:100%;padding:0px;color: white;">
		...
		<div class="selected data_tab_right">卓币转账</div>
		<div class="data_tab_left">油气转账</div>
	</div>
	<div class="data_box data_box1">
		...
		<div class="data_cent">
			...
			<div class="ct_lf">
				<div class="cb_tle">可用卓币：</div>
				<div class="cb_val">${user.userPurse.availablecoin!=null?user.userPurse.availablecoin:'0.00' }</div>
			</div>
			<div class="ct_lf">
		...
		<div class="sub_btn" id="callCash" onclick="cashSave()"
			style="background:rgba(32, 162, 226, 0.87);-moz-border-radius:6px;-webkit-border-radius:6px;border-radius:6px;">卓币转账</div>
		<div class="data_cent">
			<div style="font-size:20px;margin-top:10px;">卓币转账须知</div>
...
<script type="text/javascript">
	$(function() {
		...
		window.cashSave=function() {
			...
			var totalonline="${not empty user.userPurse.availablecoin ? user.userPurse.availablecoin:'0.00'}"
			var isnul = true;
			...
			if (cashpassword == '' || cashpassword == null) {
				...
				if (istrue) {
					...
					$.ajax({
						type : "POST",
						url : "${wx}/weixin/user/transferCoin",
						data : {

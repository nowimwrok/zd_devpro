...
<body>
	<div id="content">
		...
		<div id="carInfo">
			<div>
				<p>始发地：</p>
				<input type="text" id="txtStartCity" name="startCity" placeholder="请输入出发城市" readonly="readonly"/> <input type="hidden" name="fromProvince"
					id="FromProv"> <input type="hidden" name="fromCity" id="FromCity"> <input type="hidden" name="fromDistrict" id="FromArea">
			</div>
			<div>
				<p>目的地：</p>
				<input type="text" id="txtEndCity" name="endCity" placeholder="请输入到达城市" readonly="readonly"/> <input type="hidden" name="toProvince" id="ToProv">
				<input type="hidden" name="toCity" id="ToCity"> <input type="hidden" name="toDistrict" id="ToArea">
			</div>
			<div>
				<p>车型要求：</p>
			...
			<div>
				<input id="txtFlag" type="hidden" value="<%=request.getAttribute("flag")%>" />
				<input id="btnSearch" type="button" onclick="searchGoods()" value="搜    索" />
			</div>
		</div>
	</div>
	<script type="text/javascript" src="static/js/jquery-1.7.2.js"></script>
	<script type="text/javascript" src="static/js/weixin/jquery.pcc.js"></script>
	<script type="text/javascript" src="static/js/weixin/findgoods.js"></script>
</body>
</html>

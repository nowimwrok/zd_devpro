...
<title>${fns:getConst('SYSTEMTITLE')}--一卡通申请</title>
...
<body>
	...
	<div class="data_box data_box0">
		<div class="data_title">申请一卡通</div>
				...
				<div class="ct_lf">
					...
					<div class="cb_val red" style="font-size: 20; font-weight: bold;">
						<input type="text" id="address"
							...
							style="height: 45px; border-bottom: 1px solid #ccc; width: 98%;"
							placeholder="请选择所在地区" /><input id="fromprovince" name="province"
							type="hidden"> <input id="fromcity" name="city"
							type="hidden"> <input id="fromdistrict" name="district"
							type="hidden">
					</div>
				</div>
				<div class="ct_lf">
		...
		<!--data_cent end  -->
		<div class="sub_btn" id="apply" onclick="applyCard()"
			style="background: rgba(32, 162, 226, 0.87); -moz-border-radius: 6px; -webkit-border-radius: 6px; border-radius: 6px;">免费办理</div>
		<div class="sub_btn" id="toloss"
			style="display: none; background: rgba(32, 162, 226, 0.87); -moz-border-radius: 6px; -webkit-border-radius: 6px; border-radius: 6px;">
			<a href="#" onclick="tolossCard();" style="color: white;">我要挂失</a>
		</div>
		<!-- <div class="data_cent">
...
<script type="text/javascript">
	$(function() {
		...
		/* window.tolossCard = function() {
			window.location.href = '${wx}/weixin/user/toLossCard';
		} */
		$("#address").PCC({
			hasCounty : true,
			width : 360,

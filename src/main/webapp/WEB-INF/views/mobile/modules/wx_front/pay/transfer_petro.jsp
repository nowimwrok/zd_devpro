...
<title>${fns:getConst('SYSTEMTITLE')}--油气转账</title>
...
<body>
	<div class="data_top data_tab" style="width:100%;padding:0px;color: white;">
		<div class="data_tab_left">余额转账</div>
		<div class="data_tab_right">卓币转账</div>
		<div class="selected data_tab_right">油气转账</div>
	</div>
	<div class="data_box data_box1">
			...
			<div class="ct_lf">
				...
				<div class="cb_val red" style="font-size:20;font-weight:bold;">
					<div style="float:left;width:65%;padding-top:10px;">
						<input type="text" id="searchinfo" placeholder="请输入用户名/手机号/卡号" style="width:100%;" />
					</div>
		...
		<div class="data_cent">
			...
			<div class="ct_lf">
				<div class="cb_tle">可用油气：</div>
				<div class="cb_val">${user.userPurse.petrolbalance!=null?user.userPurse.petrolbalance:'0.00' }</div>
			</div>
			<div class="ct_lf">
		...
		<div class="sub_btn" id="callCash" onclick="cashSave()"
			style="background:rgba(32, 162, 226, 0.87);-moz-border-radius:6px;-webkit-border-radius:6px;border-radius:6px;">油气转账</div>
		<div class="data_cent">
			<div style="font-size:20px;margin-top:10px;">油气转账须知</div>
...
<script type="text/javascript">
	$(function() {
		...
		window.cashSave=function() {
			...
			var totalonline="${not empty user.userPurse.petrolbalance ? user.userPurse.petrolbalance:'0.00'}"
			var isnul = true;
			...
			if (cashpassword == '' || cashpassword == null) {
				...
				if (istrue) {
					...
					$.ajax({
						type : "POST",
						url : "${wx}/weixin/user/transferPetro",
						data : {

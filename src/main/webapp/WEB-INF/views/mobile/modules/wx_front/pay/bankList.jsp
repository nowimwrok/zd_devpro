...
<head>
    <title>${fns:getConst('SYSTEMTITLE')}--银行卡列表</title>
...
<div class="card_list_wrap">
    <div class="card_list_rows">
        <div class="card_box" ng-repeat="x in datas">
            ...
            <div class="card_box_line2">
                ...
                <div class="card-manage">
                    <a href="javascript:void(0)" ng-click="deteleAccount(x.id)">删除账户</a>
                </div>
                <div></div>
            </div>
        ...
        <div class="add_card card_box" style="border:none;" ng-if="datas==null || datas.length<3 ">
            <a href="${wx}/weixin/userbankinfo/toBindBankCard">
                <i class="add_icon">
...
<script type="text/javascript">
    ...
    app.controller('userBankCtrl', function ($scope, $http) {
        $http({
            method: 'POST',
            url: '${wx}/weixin/userbankinfo/bankList'
        }).success(function (data) {
            $scope.datas = data.value;
        });

        $scope.change = function (id) {
        	window.location.href = "${wx}/weixin/userbankinfo/isDefault?id=" + id;
        };
        $scope.deteleAccount = function (id) {
            $.MsgBox.Confirm("删除提示", "是否删除该卡?", function () {
                window.location.href = "${wx}/weixin/userbankinfo/deteleBank?id=" + id;
            }, function () {

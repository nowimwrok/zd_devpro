...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/wlpt/bid/account/">竞标结算信息列表</a></li>
    <li class="active"><a href="${ctx}/wlpt/bid/account/detail">个人交易结算详情</a></li>
</ul>
<form:form id="searchForm" modelAttribute="consumerecod" action="${ctx}/wlpt/bid/account/detail" method="post"

															...
															function(v, h, f) {
																if (v == "ok") {
																	$(
																			...
																			.attr(
																					"action",
																					"${ctx}/wlpt/consume/useraccount/typeExport?models=1");
																	$(
																			"#searchForm")
																			.submit();
																}
...
<body>
	<ul class="nav nav-tabs">
		<li><a
			href="${ctx}/wlpt/consume/useraccount/detailByType?trademodel=0"
			alt="查看所有交易">充值交易流水详情</a></li>
	</ul>
	...
	<table id="contentTable"
		...
		<thead>
			<tr>
				...
				<th colspan="6" class="center" style="vertical-align: middle">用户信息</th>
			...
			<c:forEach items="${page.list}" var="account" varStatus="step_status">
				<tr>
					...
					<%--  <td>user.
                        ${user.id} </a> </td> --%>
					<td><a
						href="${ctx}/wlpt/consume/useraccount/detailByType?trademodel=0&id=${account.user.id}"

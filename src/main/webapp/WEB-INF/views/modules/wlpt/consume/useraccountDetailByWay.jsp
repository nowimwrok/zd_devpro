		...
		function() {
										...
										function(v, h, f) {
											if (v == "ok") {
												$(
														...
														.attr(
																"action",
																"${ctx}/wlpt/consume/consumerecod/consumeRecodPetrolExportByType?id=${userid}&consumeway=${consumeway}&tradeType=${tradeType}");
												$(
														"#searchForm")
														.submit();
											}
			...
			.click(
					function() {
						$("#searchForm")
								.attr("action",
										"${ctx}/wlpt/consume/useraccount/detailByway?id=${userid}&consumeway=${consumeway}&tradeType=${tradeType}");
						$("#searchForm").submit();
					});
		});
	function page(n, s) {
...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a
			href="#" onclick="history.go(-1)">油气报表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="consumerecod"
		action="${ctx}/wlpt/consume/useraccount/detailByway?id=${userid}&consumeway=${consumeway}&tradeType=${tradeType}"
	...
	<table id="contentTable"
		...
		<thead>
			<tr>
				...
				<th colspan="2" class="center" style="vertical-align: middle;">POS机信息</th>

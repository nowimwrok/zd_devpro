...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/Userinfo/modifyCashPwd">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="userinfo" action="${ctx}/sys/Userinfo/modifyCashPwd" method="post" class="form-horizontal">
		<form:hidden path="id"/>

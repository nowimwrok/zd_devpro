...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#btnSubmit").click(
				function() {
					$("#searchForm").attr("action","${ctx}/wlpt/account/memberTreeFlowList");
					$("#searchForm").submit();
				});
		$("#btnExport").click(
				function() {
					top.$.jBox.confirm("确认要导出流水数据吗？","系统提示",
									function(v, h, f) {
										if (v == "ok") {
											$("#searchForm").attr("action","${ctx}/wlpt/account/exportTreeFlow");
									        $("#searchForm").submit();
										}
									},
									{
...
<body>
	<div>
		<form:form id="searchForm" action="${ctx}/wlpt/account/memberTreeFlowList"

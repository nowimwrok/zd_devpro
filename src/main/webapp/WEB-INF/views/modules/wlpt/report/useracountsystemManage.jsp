                                                                ...
                                                                function (v, h, f) {
                                                                    if (v == "ok") {
                                                                        $(
                                                                                ...
                                                                                .attr(
                                                                                        "action",
                                                                                        "${ctx}/wlpt/consume/useraccount/userAccountBalanceVoExport");
                                                                        $(
                                                                                "#searchForm")
                                                                                .submit();
                                                                    }
...
<table id="contentTable"
    ...
    <tr>
        ...
        <th colspan="2" class="center ">帐户钱包</th>
        <th colspan="7" class="center ">运单模块</th>
    ...
    <c:forEach items="${page.list}" var="account" varStatus="step_status">
        <tr>
            ...
            <%-- <td>
                <fmt:formatNumber value="${account.user.userPurse.webbalance != null ? account.user.userPurse.webbalance:0.0}" type="Double"

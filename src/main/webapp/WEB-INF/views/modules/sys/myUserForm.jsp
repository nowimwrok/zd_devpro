...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/user/myUserlist">子账户列表</a></li>
		<li class="active"><a
			href="${ctx}/sys/user/myUserform?id=${user.id}">子账户<shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="user"
		action="${ctx}/sys/user/saveMyuser" method="post"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="role.enname" class="input-xlarge">
					<form:option value="U_salesman" label="业务员" />
					<form:option value="U_financial" label="财务员" />
				</form:select>
			</div>
		</div>
		<div class="control-group">

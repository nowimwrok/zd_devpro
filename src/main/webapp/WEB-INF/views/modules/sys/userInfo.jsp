...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${wlpt}/wlpt/user/form">编辑信息</a></li>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" class="form-horizontal"><%--
		...
		<div class="control-group">
			...
			<div class="controls">
				账户余额:${user.userPurse.webbalance >0?user.userPurse.webbalance:0.00}元<br>
				可用资金:${user.userPurse.availablebalance >0?user.userPurse.availablebalance:0.00}元
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="userinfo.telphone" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">公司名称:</label>
			<div class="controls">
				<form:input path="userinfo.companyname" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">

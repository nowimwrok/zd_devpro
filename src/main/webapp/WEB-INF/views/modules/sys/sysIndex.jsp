...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			/* var i="${zd}";
			if(i.length>0){
				location.href="${wlpt}/wlpt/user/loginSucceed";
			} */
	...
	<div id="main">
			...
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息">您好, ${fns:getUser().loginName}&nbsp;<span id="notifyNum" class="label label-info hide"></span></a>
						<ul class="dropdown-menu">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.zhuoda56.com" target="_blank">zhuoda56</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<%-- </c:if> --%>

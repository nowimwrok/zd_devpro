...
<div class="tab_fir tab-all" style="height: 940px;">
        <p class="user_data">
            <img src="${ctxStatic }/images/wlptfront/line-left.png"/><span class="title_blue">车源</span>
        ...
        <table width="100%" border="0" style="margin-top:10px;">
            ...
            <tr>
                <td class="cy_left_td xiao_td">本次路线：</td>
                <td class="cy_center_td xiao_td">
                ${carsource.mainroad}
                </td>
            </tr>
            <tr>
                <td class="cy_left_td xiao_td">发车时间：</td>
                <td class="cy_center_td xiao_td">
               <fmt:formatDate value="${carsource.departuretime}" pattern="yyyy-MM-dd"/>
                </td>
            </tr>
            <c:if test="${not empty carsource.contactname}">
            <tr>
                <td class="cy_left_td xiao_td">联系人：</td>
                <td class="cy_center_td xiao_td">${carsource.contactname }</td>
            </tr>
            </c:if>
            <c:if test="${not empty carsource.contactmobile}">
            <tr>
                <td class="cy_left_td xiao_td">联系人号码：</td>
                <td class="cy_center_td xiao_td">${carsource.contactmobile }</td>
            </tr>
            </c:if>

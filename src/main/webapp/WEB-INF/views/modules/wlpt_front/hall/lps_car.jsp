...
<head>
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=3.0&ak=DSYi3VkjBcTkHoxSjBS9130D"></script>
    <!-- 加载百度地图样式信息窗口 -->
...
<script type="text/javascript">
    ...
    var customLayer=new BMap.CustomLayer({geotableId:'172513',ak:'DSYi3VkjBcTkHoxSjBS9130D'});
    ...
    $('#searchBtn').click(function () {
        ...
        if(keyword){
            ...
            map.clearOverlays();
            customLayer=new BMap.CustomLayer({geotableId:'172513',ak:'DSYi3VkjBcTkHoxSjBS9130D'});
            map.addTileLayer(customLayer);
            customLayer.addEventListener('hotspotclick',callback);
        }
    });
    ...
    function searchAction(keyword) {
        ...
        $.getJSON(url, {
            'q': keyword, //检索关键字
            'geotable_id': 172513,
            'ak': 'DSYi3VkjBcTkHoxSjBS9130D'  //用户ak
    ...
    function renderMap(res) {
        ...
        map.removeTileLayer(customLayer);
            var myIcon = new BMap.Icon("${ctxStatic}/images/wlptfront/hctb.png", new BMap.Size(30,50));

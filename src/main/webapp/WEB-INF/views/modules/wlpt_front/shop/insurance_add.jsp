...
<form method="post" id="Form">
    <div class="main-center">
                        ...
                        <c:if test="${not empty insurlist.subtype }">
                            <c:forEach items="${fn:split(insurlist.subtype,'|')}" var="val" varStatus="i">
                                <input type="checkbox" id="sub_type${i.index}" name="sub_type" class="a1"
                                    ...
                                    ${i.index==0?'checked="checked"':''} ${i.index==0?'disabled="disabled"':''}
                                       value="${val }"/>${val }
                            </c:forEach>
                        </c:if>
                    </div>
            ...
            <c:if test="${insurlist.insuranceway eq 1 }">
                ...
                <div class="from_group">
                    <div class="one">
                        ...
                        <input type="text" id="sendtime" class="Wdate a1" name="sendtime" readonly="readonly"
                               placeholder="登记日期"
            ...
            <div class="baodan-three">
                ...
                <div class="from_group">
                    ...
                    <div class="two">
                        ...
                        <input type="text" id="detail_faddress" class="a1" name="shipAddress.address"
                               placeholder="始发详细地址"/>
                    </div>
                </div>
                ...
                <div class="from_group">
                    ...
                    <div class="two">
                        ...
                        <input type="text" id="detail_taddress" class="a1" name="consignAddress.address"
                               placeholder="目的详细地址"/>
                    </div>
                </div>
            ...
            <div class="from_group" style="height: 150px;">
                <div class="one" style="height: 140px;width:70%;">
                    ...
                    <div class="imgdiv" style="width: 70%;text-align: center;margin-left: 40px;">
                        <input type="hidden" id="idCardImg" name="idCardImg" htmlEscape="false" maxlength="255"
                               class="input-xlarge">
        ...
        <div class="from_group" style="height: 150px;">
            <div class="one" style="height: 140px;width:70%;">
                ...
                <div class="imgdiv" style="width: 70%;text-align: center;margin-left: 40px;">
                    <input type="hidden" id="vehicleLicenseImg" name="vehicleLicenseImg" htmlEscape="false"
    ...
    <div class="from_group" style="height: 150px;">
        <div class="one" style="height: 140px;width:70%;">
            ...
            <div class="imgdiv" style="width: 70%;text-align: center;margin-left: 40px;">
                <input type="hidden" id="qualifiedImg" name="qualifiedImg" htmlEscape="false" maxlength="255"
                       class="input-xlarge">
    ...
    <div class="from_group" style="height: 150px;">
        <div class="one" style="height: 140px;width:70%;">
            ...
            <div class="imgdiv" style="width: 70%;text-align: center;margin-left: 40px;">
                <input type="hidden" id="invoiceImg" name="invoiceImg" htmlEscape="false" maxlength="255"
                       class="input-xlarge">
    ...
    <div class="baodan-four">
        ...
        <c:if test="${insurlist.insuranceway eq 0 }">
            <div class="from_group">
                ...
                <div class="two">
                    <label>保险费合计(元):</label>
                    <input type="text" class="a1" name="insurancefeel" value="${insurlist.insurAmount }"
                           readonly="readonly"/>
                </div>
            </div>
        </c:if>
                ...
                success: function (data) {
                    if (data.state == 1) {
                        ...
                        $.MsgBox.Confirm("温馨提示", "您的保单已提交，可立即支付或在我的保单页面后续支付。是否立即支付？", function () {
                            window.location.href = "${wlpt}/wlpt/shop/toinsurancepay?id=" + data.data.id + "&index=4";
                        }, function () {

...
<div class="tab-sec tab-all">
    ...
    <form id="inputForm">
        ...
        <%-- <label>兑换金额 </label>
			${petrolexchange.totalcost }
            
         <label>总条数 </label>
			${petrolexchange.exchangeCount }
             --%>
       <label>兑换金额: </label>

            <input type="text" style="margin: 5px;border: 0px;"  value="${petrolexchange.totalcost } 元" readonly="readonly"/>
         <label>总条数: </label>

            <input type="text" style="margin: 5px;border: 0px;"  value ="${petrolexchange.exchangeCount } 条" readonly="readonly"/>
         <label>审核状态: </label>

            <input type="text" style="margin: 5px;border: 0px;"  value ="${fns:getDictLabel(petrolexchange.status, 'exchange_status', '')}" readonly="readonly"/>

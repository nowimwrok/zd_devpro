...
<body>
<ul class="qiye_menu">
    <li data-type="1"><a href="${wlpt}/wlpt/consume/myMetroPosList" target="content" style="color: #000;">我的POS机</a></li>
    <li data-type="2" class="qiye_menu_1">余额兑换</li>
</ul>
        <div class="withdraw_cash_wrap">
        <p class="user_data">
            <img src="/static/images/wlptfront/line-left.png"><span class="title_blue">余额</span><span class="title_orange">兑换</span><img src="/static/images/wlptfront/line-right.png">
        </p>
            <table>
            	<tr>
                    <td class="left_title" style="width:20%;">当前余额：</td>
                    <td class="right_con right_con_1" style="width:25%;font-size: 16px;">
                        ${not empty user.userPurse.availablebalance ? user.userPurse.availablebalance:'0.00'}&nbsp;元
                    </td>
                ...
                <tr>
                    ...
                    <td class="right_con please_note" colspan=3>请注意：仅支持油气兑换，在线支付成功后。兑换金额会在一分钟内到账；如有疑问，请致电卓大物流客服办理</td>
                </tr>
                <tr>
                    <td class="left_title"></td>
                ...
                <tr>
                    <td class="right_con cash_type_list" colspan=4>
                        <a class="btn btn-default bg_blue_btn" id="btnSubmit">兑换</a>
                    </td>
                </tr>
            </table>
            <!-- <div class="loading">
...
$("#btnSubmit").click(function () {
    ...
    if (nul) {
    	...
    	var total="${not empty user.userPurse.petrolbalance ? user.userPurse.petrolbalance:'0.00'}"
    	if(num*1>total*1){
    		$("#num").tips({
                side: 3,
                msg: '可用油气不足',
    		...
    		$.ajax({
	            ...
	            success: function (data) {
	                if (data == false) {
	           		 ...
	           		 $.ajax({
	     	            url: "${wlpt}/wlpt/consume/exchangePetro",
	     	            dataType: 'json',
	     	            data:{"consumemony":num,"coinnum":num},
	     	            type: "post",
	     	            success: function (data) {
	     	                if (data.value == 1) {
	     	                	window.location.href = '${wlpt}/wlpt/consume/myMetroPosList';

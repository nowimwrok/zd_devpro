...
<link href="${ctxStatic}/front/css/animate.css" type="text/css" rel="stylesheet"/>
<link href="${ctxStatic}/front/css/new_erStyle.css" type="text/css" rel="stylesheet"/>
<link href="${ctxStatic}/front/css/new_style.css" type="text/css" rel="stylesheet"/>
<link href="${ctxStatic}/front/css/swiper.min.css" type="text/css" rel="stylesheet"/>
<%--
<link href="${ctxStatic}/front/css/per_global.css?id=4" type="text/css" rel="stylesheet"/>
--%>
...
<script src="${ctxStatic}/front/js/bootstrapValidator.js?id=4"></script>
...
<script src="${ctxStatic}/front/js/swiper.min.js"></script>
<script src="${ctxStatic}/front/js/jqthumb.min.js"></script>
<script src="${ctxStatic}/front/js/angular.min.js"></script>
<script src="${ctxStatic}/front/js/tm.pagination.js"></script>

<script src="${ctxStatic}/front/js/swiper.animate1.0.2.min.js"></script>
<script src="${ctxStatic}/front/js/jquery.SuperSlide.2.1.2.js"></script>
<script src="${ctxStatic}/front/js/wow.min.js"></script>
<script src="${ctxStatic}/front/js/jquery.smooth-scroll.js"></script>
<script src="${ctxStatic}/front/js/num.js"></script>
<script src="${ctxStatic}/front/js/index.js"></script>

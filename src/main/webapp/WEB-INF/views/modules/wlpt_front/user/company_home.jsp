...
<div class="body-wrap" ng-app="companyApp">
    <div class="platform-info">
        <div class="banner">
        <div class="logo">${ not empty enterprise.companyname?enterprise.companyname: user.loginName}</div>
            ...
            <div class="abs">
                <div class="abs-left">
                    <c:if test="${enterprise.companyinfo==null}">
                                                                        暂无介绍
                    </c:if>
                    <c:if test="${enterprise.companyinfo !=null}">
                        <p style="text-indent:2em">企业介绍：${enterprise.companyinfo }
                        </p>
                    </c:if>
                </div>
                <div class="abs-right">
    ...
    <div class="transction clerify" ng-controller="honestyCtrl">
        ...
        <input type="hidden" id="company" value="${user.userCompany.id}">
        ...
        <div class="transction clerify">
            <div class="panel panel-default">
                <div class="panel-heading head-cl"><a name="server"></a>
                    <img src="${ctxStatic}/images/wlptfront/icon-10.png"><span>&nbsp;&nbsp;产品及服务</span>
                </div>
                <div class="panel-body product-server">
                    ${not empty userCompany.productserver?userCompany.productserver:'' }
                </div>
            </div>
        </div>
        ...
        <div class="transction clerify">
            <div class="panel panel-default">
                <div class="panel-heading head-cl"><a name="contact"></a>
                    <img src="${ctxStatic}/images/wlptfront/icon-10.png"><span>&nbsp;&nbsp;联系我们</span>
                </div>
                <div class="panel-body">
                    <div class="contactus">
                        <h3>联系方式</h3>
                        <p class="ruixiang">-${user.userCompany.companyname }-</p>
                        <p>在线客服<img src="${ctxStatic}/images/wlptfront/QQ.jpg">
                            <a href="http://wpa.qq.com/msgrd?v=1&uin=${user.userCompany.companyqq }&site=qq&menu=yes" title="点击与我进行交谈"
                               style="color:#F60" target="_blank">点击交谈</a>
                        </p>
                    </div>
                    <hr style="border-bottom:1px dashed #ccc;width:90%;margin-left:30px">
                    <div class="contactus">
                    	<p>企业名称：${enterprise.companyname }</p>
                        <p>电话：${enterprise.linkphone }</p>
                        <p>地址：<i>${enterprise.companyaddress }</i></p>
                    </div>
                </div>
...
<script>
    ...
    app.controller('honorCtrl', function ($scope, $http) {
        $http({
            url: '${wlpt}/wlpt/credit/getEnterprise',
            method: 'GET',
            params: {
                'user.id': $('#userid').val()
            }

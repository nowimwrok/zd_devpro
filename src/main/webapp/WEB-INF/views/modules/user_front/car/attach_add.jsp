        ...
        <div class="col-lg-12">
            	...
            	<div class="form_container">
            		<div class="panel clearfix">
            			<h4 class="panel-heading">司机搜索</h4>
            			<div class="col-sm-6 form-horizontal" style="margin-top:25px;">
             			<div class="col-sm-12 form-group">
             				...
             				<div class="text-left" style="line-height: 35px;height: 35px;"><a  data-toggle="modal"
                                        data-target="#myModal" onclick="search();" class="see oprate">常用联系人</a></div>
             			</div>
             			<div class="col-sm-12 form-group">
             				<div class="col-sm-3 text-right control-label">
             					搜索说明
             				...
             				<div class="col-sm-7 text-left" >
             					<p class="search_e" id="addinfo">请输入需要绑定司机的完整用户名或手机号，然后绑定指定司机即可！</p>
             				</div>
             			</div>
             			<div class="col-sm-12">
            			...
            			<div class="col-sm-4  form-horizontal" >
            				...
            				<form:form id="inputForm" modelAttribute="user" action="${wlpt}/wlpt/driver/saveAttach" method="post">
            					...
            					<div class=" clearfix col-sm-12 content_list">
		              				<div class="col-sm-6 label-control text-right">
		              					登录名：
		              				</div>
		              				<div class="col-sm-4 text-left list_c" id="login">
            					...
            					<div class="clearfix col-sm-12 content_list">
            						<div class="col-sm-6 label-control text-right">
		              				...
		              				<div class="col-sm-4 text-left list_c" id="name">
            					...
            					<div class=" clearfix col-sm-12 content_list">
		              				...
		              				<div class="col-sm-4 text-left list_c" id="phone">
            					...
            					<div class="clearfix col-sm-12 content_list">
		              				...
		              				<div class="col-sm-4 text-left list_c" id="status">
		              					
		              				</div>
            					</div>
            					<div class="col-sm-12 clearfix">
            						<input type="button" class="btn col-sm-6 col-sm-offset-3 btn-danger" id="btnSubmit" style="margin-top:3px;" value="绑  定">
            					</div>
            					</form:form>
            				</div>
            			</div>
...
<script type="text/javascript">
    ...
    function search() {
        ...
        if (searchinfo!='' || searchinfo!="") {
                ...
                success: function (data) {
                    if (data) {
                        if (data.value == '未查到指定用户') {
                            ...
                            $("#addinfo").html("请输入需要绑定司机的完整用户名或手机号，然后绑定指定司机即可！");
                            $(".search_img").hide();
                            $("#info").show();
                        }
                    }
        	...
        	$.MsgBox.Alert("温馨提示", '请填写用户信息');
        }
    }
    $("#btnSubmit").click(function () {
        if ($("#status").html() == "认证：未通过") {
            $.MsgBox.Alert("温馨提示","用户未认证，不可绑定！");
            return false;
        }
        if ($("#role").val() != "carowner") {
        	 $.MsgBox.Alert("温馨提示","绑定的用户只能是车主！");
            return false;
        }

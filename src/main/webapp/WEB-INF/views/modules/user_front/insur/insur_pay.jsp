    ...
    <div class="shop_content">
        ...
        <table class="pur_tab" style="margin-bottom: 30px;    border-bottom: 1px dashed #ccc;">
            ...
            <tr>
                ...
                <td class="tab_right"><span id="available">${not empty user.userPurse.availablebalance?user.userPurse.availablebalance:'0.00'}</span>元</td>
            </tr>
            <tr>
            ...
            <tr style="height: 70px;" id="zhifu">
                ...
                <td class="tab_right" style="width: 50%;"><input id="password"  type="password" style="height: 28px;line-height: 28px;width:102px;"/></td>
            </tr>
            <tr class="colspan2">
                	...
                	$.ajax({
                        ...
                        success: function (data) {
                            if (data.value == 6) {
                            	...
                            	//window.location.href = "${wlpt}/wlpt/insur/insur_list";
                                $("#mone").show();
                                $("#sub").hide();
                            }else if(data.value == -1){
                            	$(".loading").hide();

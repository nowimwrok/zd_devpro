			...
			<div class="col-sm-12 clearfix map">
				...
				<div class="map_l">
                    ...
                    <div class="col-sm-9" style="padding:0;">
                        <input type="text" id="searchinfo" name="searchinfo" value="" placeholder="请输入车牌号码或运单号"
                               class="form-control">
                        <i class="glyphicon glyphicon-search"></i>
                    </div>
                    <button class="col-sm-3 btn btn-primary" ng-click="searchInfo()">查询</button>
                </div> -->
					<!--table内容-->
				...
				<div class="map_r pull-right">
					<button class="closeAll" style="opacity: .8;">&times;</button>
					<div class="col-sm-6">
						...
						<div class="col-sm-12  car_check" >
							<div class="col-sm-12 clearfix">
								<div class="pull-left">
									...
									<div>
										<a class="tdFir" ng-click="getOrderinfobycar()">追踪</a>
									</div>
								</div>
  ...
  //显示隐藏底下内容
    ...
    app.controller('dataHallCtrl', ['$scope', '$http', function ($scope, $http) {
                    	...
                    	if(data[2] != null && data[2][0] != null){
                    		...
                    		var LocationVcln=data[3].LocationVcln.LocationVcln;
	                  			if(LocationVcln!=null && LocationVcln.hasOwnProperty('utc')){
	                  				...
	                  				//$("#x_address").html("位置："+data.value[3].LocationVcln.adr);
	                  			}else{
	                  				$.MsgBox.Alert("系统提示", "该车辆无定位信息");
	                  			}
                    	}
        ...
        $scope.getOrderinfo = function (orderno, carnumber) {
            ...
            var  newtimes=new Date().getHours();
            $.ajax({
                url: "${wlpt}/wlpt/trade/carAndTradeInfo",
                data: {
                    orderNos: orderno,
